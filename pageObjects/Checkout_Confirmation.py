...
from CursosPythonSelenium.EndToEndsTest import countryCheck


class Checkout_Confirmation:
    def __init__(self, driver):
        self.countryCheck = "Armenia"
        self.driver = driver
        self.checkout_button = (By.CSS_SELECTOR, ".btn.btn-success")
        self.country_input = (By.ID, "country")
        self.country_option = (By.LINK_TEXT, countryCheck)
    ...
    def country_delivery(self,countryName):
        ...
        self.driver.find_element(By.LINK_TEXT, self.countryCheck).click()
